...
enum class HoldColorCategory(
    ...
    GRAY(hueCenter = null, referenceValue = 0.56f, isNeutral = true),
    ORANGE(hueCenter = 28f, referenceValue = 0.84f, isNeutral = false),
    BROWN(hueCenter = 24f, referenceValue = 0.42f, isNeutral = false),
    RED(hueCenter = 0f, referenceValue = 0.72f, isNeutral = false),
    PINK(hueCenter = 338f, referenceValue = 0.88f, isNeutral = false),
